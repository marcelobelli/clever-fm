from helpers import raw_transcript_to_excerpts


def test_transform_raw_transcript_into_clean_full_excerpts():
    raw_transcript = [
        "0:01  ",
    ...
    excerpts = [excerpt for excerpt in raw_transcript_to_excerpts(raw_transcript)]
